...
<h6> *** Goods once sold will not be taken back or exchanged.***<br>
 *** All disputes are subject to Bhubaneswar Jurisdiction only.***<br>
  THANK YOU! VISIT AGAIN ***</h6>
  </div>

  <?php if (!$forPdf): ?>
  <div class="text-center no-print mt-3">
    <button class="btn btn-primary" onclick="window.print()">🖨 Print</button>
   <a href="../../pharma_retail/salesnbilling/create_bill.php" class="btn btn-outline-secondary">➕ New Bill</a>
