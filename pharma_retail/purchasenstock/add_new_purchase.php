...
<div class="container-fluid">
  <?php pageHeader("🧾 Add New purchase", "primary"); ?>
  <h3 class="mb-3">🛒 Add New Purchase</h3>

  <form id="purchaseForm" method="POST" action="../save/save_purchase.php">
    <!-- Purchase Header -->
      ...
      <div class="form-group col-md-3">
        ...
        <select class="form-control" id="supplier_id" name="supplier_id" required>
          ...
          <?php foreach($parties as $p): ?>
            <option value="<?= $p['id']; ?>"><?= htmlspecialchars($p['supplier_name']); ?></option>
          <?php endforeach; ?>
        </select>
      </div>
      <div class="form-group col-md-2">
    ...
    <div class="d-flex justify-content-between mt-3">
      ...
      <div>
        ...
        <button type="button" class="btn btn-secondary" id="newBillButton">New Bill</button>
      </div>
    </div>
  </form>
</div>
